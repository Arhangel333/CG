...
void initialize(VkCommandBuffer cmd) {
    ...
    // ---- Текстуры и сцена ----
    {
        ...
        auto* wood  = load_texture(cmd, "assets/wood.jpg");
        auto* brick = load_texture(cmd, "assets/brick.jpg");
        auto* metal = load_texture(cmd, "assets/metal.jpg");
    ...
    .textures = {wood,nullptr,nullptr,linear_sampler}
        ...
        models.push_back({
            ...
            .textures = {brick,metal,nullptr,linear_sampler}
        });
        ...
        models.push_back({
            ...
            .textures = {metal,wood,nullptr,linear_sampler}
        });
        ...
        models.push_back({
            ...
            .textures = {wood,brick,nullptr,linear_sampler}
        });
        ...
        models.push_back({
            ...
            .textures = {nullptr,metal,nullptr,nearest_sampler}
        });
